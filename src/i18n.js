const MESSAGES = {
  en: {
    ...
    commentPostedAndFinished: 'tracker-boot: comment posted and story {storyId} set to Finished.',
    statusUpdateError: 'tracker-boot: failed to update status for story {storyId}: {message}',
  ...
  ko: {
    ...
    commentPostedAndFinished: 'tracker-boot: 댓글이 게시되고 스토리 {storyId}의 상태가 Finished로 설정되었습니다.',
    statusUpdateError: 'tracker-boot: 스토리 {storyId}의 상태 업데이트에 실패했습니다: {message}',
  ...
  ja: {
    ...
    commentPostedAndFinished: 'tracker-boot: コメントが投稿され、ストーリー{storyId}のステータスをFinishedに設定しました。',
    statusUpdateError: 'tracker-boot: ストーリー{storyId}のステータス更新に失敗しました: {message}',
